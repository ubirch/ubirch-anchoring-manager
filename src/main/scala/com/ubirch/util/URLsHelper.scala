...
object URLsHelper {
  ...
  case class NoContactPointsException(message: String) extends Exception(message)
  case class InvalidContactPointsException(message: String) extends Exception(message)
